function New-APServiceEndpointBranchCheck
{
    <#
    .SYNOPSIS

    Creates an Azure Pipeline service endpoint branch check.

    .DESCRIPTION

    Creates an Azure Pipeline environment branch check based on endpoint id.
    The id can be retrieved with Get-APServiceEndpoint.
    ...
    The name or id of the endpoint to create the approval for.
    ...
    New-APServiceEndpointBranchCheck -Session $session -DisplayName 'My DisplayName' -EnvironmentId 2 -TimeoutDays 3 -BranchFilter "master,refs/heads/master" -EnsureProtectionOfBranch $false
    ...
    process
    {
        ...
        $apServiceEndpoint = Get-APServiceEndpoint @apSplat -EndpointId $EndpointId -Project $Project
        $resource = @{
            type = 'endpoint'
